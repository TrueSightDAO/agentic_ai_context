...
| **edgar.truesight.me** | [TrueSightDAO/sentiment_importer](https://github.com/TrueSightDAO/sentiment_importer) | **Edgar** — Rails **sentiment_importer** (DAO API, Sidekiq, Meta checkout helpers). Public: **`/agroverse_shop/shipping_rates`**, **`/meta_checkout`**, **`/ping`**, etc. |
