...
- **Carrier:** Correios (Entry Type *Mail (Commercial)*)
- **FDA PN:** confirmation `250541039416`, submitted 2025-03-09, anticipated 2025-03-14; product *250 grams cacao molasses*
...
| # | Item | Qty | Origin unit cost (USD) | Extended (USD) |
|---|---|---|---|---|
| 1 | Cacao Molasses 250 ml bottle | 20 | 12.143 *(ledger, landed SF)* | 242.86 |
| — | *origin molasses only (raw)* | 20 L | 2.911 /L | 58.22 *(R$300 nota fiscal)* |

**Shipment total (ledger unit costs): USD 242.86.** Origin raw-material value: USD 58.22.
...
| 14 | 2025-10-09 | hand-carried | 10 × 200 g ceremonial | 50.00 *(declared)* |

**Total measurable origin value (Correios + others): ≈ USD 5 215.60** across the 13 shipments
with quantifiable line items (excluding #12).
