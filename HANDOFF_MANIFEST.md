...
|-----------|---------------|--------------|--------|---------------------|---------------------|
| `SOPHIA_VAULT_CREDENTIAL_MIGRATION_PLAN.md` | Vault Initialization & Credential Migration (migrate /home/ubuntu/ bare credentials into encrypted vault) | 2026-06-14 | blocked | Parked GO-ready; on GO runs Units 1-6: init vault, add 7 credentials, update tools, UAT (U1-U7), docs, cleanup; **own-repo gate**; RESUME HERE = Unit 1 | 2026-06-14 |
