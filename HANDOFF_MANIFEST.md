...
|-----------|---------------|--------------|--------|---------------------|---------------------|
| `CLI_SALES_EVENT_ALIGNMENT_PLAN.md` | CLI Sales Event Audit & Alignment with DApp | 2026-06-17 | in progress | Parked GO-ready in **thread 6369** ([topic](https://t.me/c/3919341801/6369)); on GO runs PR1 (update CLI report_sales module in dao_client) → PR2 (update Edgar docs) → PR3 (re-submit Gergana's sale); **dao_client repo gate** — opens PRs only, NEVER self-merges; RESUME HERE = PR1 | 2026-06-17 |
