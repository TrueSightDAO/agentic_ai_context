...
|-----------|---------------|--------------|--------|---------------------|---------------------|
| `SOPHIA_VAULT_CREDENTIAL_MIGRATION_PLAN.md` | Vault Initialization & Credential Migration (migrate /home/ubuntu/ bare credentials into encrypted vault) | 2026-06-14 | in progress | Units 1-2 done (vault initialized, 7 credentials added); Unit 3 PR open ([#197](https://github.com/TrueSightDAO/truesight_autopilot/pull/197)); UAT (U1-U7) pending PR merge + deploy; **own-repo gate** | 2026-06-14 |
