# Retailer Onboarding Playbook — USA field visits (v0.1)

**Status:** INTERIM **v0.1** — compiled from USA retailer visits logged in the
`DApp Remarks` tab of the holistic wellness Hit List. Patterns are hypotheses
until validated on new regions or additional Partnered conversions.
**Last reviewed:** 2026-04-21
**Owner:** Agroverse / TrueSight (human: Gary + AI assist)

**Promotion to v1.0 when:** At least **3 additional Partnered conversions**
follow this playbook end-to-end without contradicting the §9–§11 patterns.

---

## 1. What this playbook is

An **in-person, field-agent** onboarding flow for small / mid-size retailers
of ceremonial cacao and cacao tea in the USA: from shortlisting through first
consignment drop to the follow-up hand-off.

It is the **index** for this flow; the specialized docs below remain the
source of truth for their sub-steps:

| Sub-step | Authoritative doc |
|----------|-------------------|
| Post-visit email drafting | [`STORE_FOLLOW_UP_EMAIL_TEMPLATE.md`](STORE_FOLLOW_UP_EMAIL_TEMPLATE.md) |
| Email cadence + Hit List hygiene | [`PARTNER_OUTREACH_PROTOCOL.md`](PARTNER_OUTREACH_PROTOCOL.md) |
...
- Wholesale / bulk industrial deals (different unit economics — see §11).
...
| — | On Hold / Rejected / Not Appropriate | See §10 disqualification patterns. | DApp Remark |

---

## 4. Pre-visit: shortlisting heuristics
...
4. **Their reaction to a taste sample** (cacao from Oscar's Farm + cacao tea
   from Paulo's Farm). The taste is what converts — see §7.

## 6. Sample drop-off protocol
...
- Do not leave samples at stores that don't sell anything ingestible (see §10).

## 7. What actually lands — patterns from Partnered stores
...
## 8. What retailers ask / worry about
...
## 9. Recurring decision-maker dynamics
...
## 10. Disqualification patterns — walk away early
...
## 11. Market-fit learnings (the "On Hold" shelf)
...
## 12. Meta-pattern — small vs large store pitch
...
## 13. Narrative pitfalls — the Brasil Kiss lesson
...
## 14. Bulk / industrial leads — escalate, don't apply this playbook
...
- [ ] Follow-up email drafted via `STORE_FOLLOW_UP_EMAIL_TEMPLATE.md` within
      the cadence window set by `PARTNER_OUTREACH_PROTOCOL.md` §5.
...
- **2026-04-21** — v0.1 created. Compiled from 332 human-submitted DApp
  ...
  58 Not Appropriate). Synthesized §7 (landing patterns), §10 (disqual),
  §11 (two-tier shelf + premium-bar SKU gap), §12 (small vs large pitch),
  §13 (Brasil Kiss narrative pitfall), §14 (Third Eye industrial escalation).
