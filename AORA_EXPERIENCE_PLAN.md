...
### 2d. Weight/volume estimates for Jerri's freight forwarder

Jerri is consulting a freight forwarder on China import requirements. Since the Aora/Go pilot is **chocolate bars only**, here are the precise estimates:
...
| **Cacao beans (bulk)** | 329 kg | ~0.55 m³ | 1801.00 | Existing DAO stock at Matheus — not in Aora/Go scope |
| **Cacao mass (pouches + bars)** | 53 kg | ~0.15 m³ | 1803.10 | Existing DAO stock — not in Aora/Go scope |
| **Cacao nibs (bulk)** | 180 kg | ~0.30 m³ | 1801.00 | Existing DAO stock — not in Aora/Go scope |
| **Cacao tea / husk** | 56 kg | ~0.15 m³ | 2106.90 | Existing DAO stock — not in Aora/Go scope |
