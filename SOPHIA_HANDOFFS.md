...
|-----------|---------------|----------------|-------------------|--------------|--------|
| `CLI_SALES_EVENT_ALIGNMENT_PLAN.md` | CLI Sales Event Audit & Alignment with DApp | [CLI Sales Event Alignment](https://t.me/c/3919341801/6369) | 6369 | 2026-06-17 | in progress |
