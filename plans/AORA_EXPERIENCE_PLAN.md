...
**Context:** **Elizabeth Wong (Liz)** is the founder of the GO/Nucleus network. Mr. Cao is her
friend and partner. Gary offered to generate two learning modules — **1. Agroforestry** and
**2. Supply Chain** — for the Aora pilot program, based on his firsthand experience in Brazil
among the farmers. The program is for mentors + children co-creating; "TED for children",
content a 6-year-old can grasp; senses: see/smell/taste/hear/create.
