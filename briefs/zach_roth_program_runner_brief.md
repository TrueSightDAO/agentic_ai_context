...
**Name:** Zachary Roth
**Current:** Potrero Capital (US-based)
**Location:** United States

**Key Background:**
- Led the complete redesign and rebuild of **PlayStation.com**
- Certifications: PMP, Certified Scrum Master, CCNP, Master Project Manager
- Languages: English (native), Spanish (limited working)
- Volunteers tutoring ESL students from Mexico and Guatemala
- Active in Japan/Asia-focused events (FINOLAB, Asian Financial Forum)
- Has expressed **openness to relocate to China long-term** to run the program
...
## 4. Key Decisions Still Pending

| # | Decision | Who Decides |
|---|----------|-------------|
| 1 | Does Evan want someone on our side to run the program? | Evan |
...
## 5. Expenses & Relocation

Zach to assess his own **cost of living** for relocating to China and what he needs to live comfortably long-term.

If Evan wants someone on our side to run the program and has a budget for it, Zach's living expenses can be **baked into the ongoing operating expenses**.
...
1. Clarify with Evan — does he want our-side staffing, and does he have a budget?
