...
| **PR-final-2** autopilot `gas_deploy_project` capability tool | [truesight_autopilot#61](https://github.com/TrueSightDAO/truesight_autopilot/pull/61) | ✅ | ☐ (operator: `./scripts/deploy.sh` + clasp install + clasp login on EC2) | ☐ |
