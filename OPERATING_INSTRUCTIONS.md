...
| — | **MANUAL_EMAIL_REGISTRATION_SOP.md** | **Manual email registration.** When the governor provides email addresses collected in-person (events, booths), register them as CONFIRMED subscribers via the GAS web app, tied to the relevant QR code batch. |
