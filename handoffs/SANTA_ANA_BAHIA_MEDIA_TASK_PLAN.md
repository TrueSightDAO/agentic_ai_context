...
5. ⏳ **PENDING — human gate:** Gary visual confirm on agroverse.shop farm page (map renders FSA-P1 polygon, gallery, cross-links work). DOM/JS/network verified, pixels not.
