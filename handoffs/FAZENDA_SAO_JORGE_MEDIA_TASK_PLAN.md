...
- Extract at `/home/ubuntu/sao_jorge_work/extracted/`; metadata rows `/tmp/sao_jorge_rows.json`; analysis complete (2026-09-02).
...
| `~/media_archive_inbox/farm-media/` | box | cleide, jedielcio, paulo-la-do-sitio, santa-anna — inbox dir fazenda-sao-jorge-bahia/ created. |
